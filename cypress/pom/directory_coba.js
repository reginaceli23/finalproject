export default class haldirectory {
    ...
    static selectJobTitle(){
        return cy.get('.oxd-select-dropdown').contains('QA Engineer').first().click();
    }

    static selectjobTitle(){
        return cy.get('.oxd-select-dropdown').contains('Software Engineer').first().click();
    }
    ...
    static selectLocation(){
        return cy.get ('.oxd-select-dropdown').contains('Texas R&D').last().click();
    }
